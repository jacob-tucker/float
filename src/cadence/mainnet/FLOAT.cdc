...
pub contract FLOAT: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        pub let eventCap: Capability<&FLOAT.FLOATEvents{MetadataViews.ResolverCollection}>
        ...
        init(_eventHost: Address, _eventId: UInt64, _serial: UInt64, _recipient: Address) {
            ...
            self.eventCap = getAccount(_eventHost)
                            .getCapability<&FLOAT.FLOATEvents{MetadataViews.ResolverCollection}>(FLOAT.FLOATEventsPublicPath)
